...
class Chapter(BaseModel):
    ...
    arc_step_refs = Column(JSON, default=list)
    continuity_from_previous = Column(JSON, default=list)
    state_delta = Column(JSON, default=dict)
    continuity_to_next = Column(JSON, default=list)
    relationship_changes = Column(JSON, default=list)
    object_states = Column(JSON, default=list)
    external_pressures = Column(JSON, default=list)
    opening_requirements_for_next = Column(JSON, default=list)
