...
系统还内置共享写作风格 Skill：可以上传小说样本文本，让 AI 从中抽取作者的技法谱系、前 20 万字留存模型、角色声音矩阵、场景施工模板、文笔工艺、段落推进、细节刻画、情绪落点、长篇适配、偏离检测和修复策略，形成跨项目复用的写作方法库。Skill 只学习抽象写法，不复制原文、剧情、人名、地名、组织名或专有设定。
...
- **写作风格学习 Skill**：上传小说样本，后台抽取技法谱系、前 20 万字留存、角色声音、场景施工、文笔工艺、长篇适配、偏离检测和修复策略，形成全局共享 Skill，并可被不同项目引用。
...
| 写作风格 Skill | 全局共享库 + 文件上传 + 后台抽取任务 + 多点代表性采样 + 技法谱系 + 留存模型 |
...
写作风格 Skill 的目标是学习“怎么写”，而不是复制“写了什么”。样本上传后会进入后台任务，系统只做多点代表性采样和抽象写法提取，沉淀为技法谱系、前 20 万字留存模型、角色声音矩阵、场景施工模板、文笔工艺、段落推进、细节工艺、人物出场、情绪落点、场景真实感、章节生产法、篇幅适配、偏离检测和修复策略。项目引用 Skill 后，Skill 进入创建、大纲、弧线、蓝图、正文、审计和修复流程，但只影响写法，不覆盖项目设定和已写事实。
